import type { CategoryItem, LabItem, LearningItem, ProjectItem } from "@/interfaces/jsonTypes";
...
import leetCodeChecklistJson from "../assets/leet_code_checklist.json";
...
export const leetCodeChecklist: CategoryItem[] = leetCodeChecklistJson;